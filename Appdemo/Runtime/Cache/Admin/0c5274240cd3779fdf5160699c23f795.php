    ...
    <div class="formbody">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <ul class="forminfo">
                ...
                <li>
                    <label>上架时间</label>
                    <input id="time" name="sale_time" placeholder="留空则表示下架" type="text"
                    class="dfinput">   
                </li>
                 <li>
                    <label>商品排序</label>
                    <input id="sort" name="sort" placeholder="商品id越大表示越靠后" type="text"
                    class="dfinput">   
                </li>
            </ul>    
            <ul class="forminfo">
                <li>
                    <label>商品描述</label>
                  <textarea id="good_desc" name="goods_desc" placeholder="请输入商品描述" cols="" rows="" class="textinput textinput2"></textarea>
                </li>
            </ul>
