...
<body>
	...
	&lt;!&ndash; 头部 start &ndash;&gt;
	<div class="header w1210 bc mt15">
		&lt;!&ndash; 头部上半部分 start 包括 logo、搜索、用户中心和购物车结算 &ndash;&gt;
		<div class="logo w1210">
			<h1 class="fl"><a href="index.html"><img src="/Public/Home/images/logo.png" alt="京西商城"></a></h1>
			&lt;!&ndash; 头部搜索 start &ndash;&gt;
			<div class="search fl">
				<div class="search_form">
					<div class="form_left fl"></div>
					<form action="" name="serarch" method="get" class="fl">
			...
			&lt;!&ndash; 头部搜索 end &ndash;&gt;

			&lt;!&ndash; 用户中心 start&ndash;&gt;
			<div class="user fl">
				<dl>
					<dt>
						<em></em>
			...
			&lt;!&ndash; 用户中心 end&ndash;&gt;

			&lt;!&ndash; 购物车 start &ndash;&gt;
			<div class="cart fl">
				<dl>
					<dt>
						<a href="">去购物车结算</a>
		...
		&lt;!&ndash; 头部上半部分 end &ndash;&gt;
		
		<div style="clear:both;"></div>
-->
		<!-- 导航条部分 start -->
	<!--	<div class="nav w1210 bc mt10">
			&lt;!&ndash;  商品分类部分 start&ndash;&gt;
			<div class="category fl cat1"> &lt;!&ndash; 非首页，需要添加cat1类 &ndash;&gt;
				<div class="cat_hd">  &lt;!&ndash; 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，鼠标滑过时展开菜单则将off类换成on类 &ndash;&gt;
					<h2>全部商品分类</h2>
					<em></em>
				</div>
