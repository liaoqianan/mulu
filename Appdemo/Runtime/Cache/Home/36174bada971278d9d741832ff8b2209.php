			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					...
					<dl>
						<dt>价格：</dt>
						<dd class="cur"><a href="">不限</a></dd>
						<dd><a href="<?php echo U('Goods/index','price=1000-1999');?>">1000-1999</a></dd>
						<dd><a href="<?php echo U('Goods/index','price=2000-2999');?>">2000-2999</a></dd>
						<dd><a href="<?php echo U('Goods/index','price=3000-3499');?>">3000-3499</a></dd>
						<dd><a href="<?php echo U('Goods/index','price=3500-3999');?>">3500-3999</a></dd>
						<dd><a href="<?php echo U('Goods/index','price=4000-4499');?>">4000-4499</a></dd>
						<dd><a href="<?php echo U('Goods/index','price=4500-4999');?>">4500-4999</a></dd>
						<dd><a href="<?php echo U('Goods/index','price=5000-5999');?>">5000-5999</a></dd>
						<dd><a href="<?php echo U('Goods/index','price=6000-6999');?>">6000-6999</a></dd>
						<dd><a href="<?php echo U('Goods/index','price=7000-7999');?>">7000-7999</a></dd>
					</dl>
			...
			<div class="goodslist mt10">
				<ul>
					<?php if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<dl>
							<dt><a href="<?php echo U('Goods/detail','id=' . $vo['goods_id']);?>"><img src="/Public<?php echo ($vo["goods_logo_thumb"]); ?>" alt="" /></a></dt>
							<dd><a href="<?php echo U('Goods/detail','id=' . $vo['goods_id']);?>"><?php echo (mb_substr($vo["goods_name"],0,25,'utf-8')); ?></a></dt>
